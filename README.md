...
## 🚀 프로젝트 소개
AI 태그 다이어리는 사용자의 기분, 태그뿐만 아니라 **날씨 정보, 건강 정보(걸음 수, 칼로리 등), 그리고 오늘 찍은 사진**을 종합하여 나만의 특별한 일기를 기록할 수 있게 도와줍니다. 특히 유료(Pro) 버전에서는 **Google Gemini AI**를 활용하여 수집된 데이터를 바탕으로 다양한 스타일의 일기를 자동으로 생성해 줍니다.
...
- **🎨 개인화 스타일**: 마지막으로 선택한 일기 스타일을 기억하고 다음 작성 시 유지
...
- **Backend (AI Proxy)**: Node.js, Express, Google Generative AI (Gemini)
